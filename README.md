...
6. In either the Github Org or repo, create a Actions Secret named `AAP_HUB_TOKEN`. Generate the token value by creating a Personal Access Token (PAT) in AAP: navigate to Access Management > API Tokens in AAP, create a new token, and use that value.
